...
class RelateBasic(unittest.TestCase):
    ...
    def testPropagatedIncludeInfo(self):
        ...
        # done locally)
        self.failIf(self.lodir_lib_includeinfo_ in self.lodir_lo_c_builder_.buildinfo_includepath())

        # same with the others
        self.failIf(self.hi1dir_lib_includeinfo_ in self.hi1dir_hi1_c_builder_.buildinfo_includepath())
        self.failIf(self.hi2dir_lib_includeinfo_ in self.hi2dir_hi2_c_builder_.buildinfo_includepath())
        self.failIf(self.highestdir_lib_includeinfo_ in self.highestdir_highest_c_builder_.buildinfo_includepath())

        # lo's include-buildinfo must have got through to the others
        self.failUnless(self.lodir_lib_includeinfo_ in self.hi1dir_hi1_c_builder_.buildinfo_includepath())
        self.failUnless(self.lodir_lib_includeinfo_ in self.hi2dir_hi2_c_builder_.buildinfo_includepath())
        self.failUnless(self.lodir_lib_includeinfo_ in self.highestdir_highest_c_builder_.buildinfo_includepath())
        self.failUnless(self.lodir_lib_includeinfo_ in self.exedir_main_c_builder_.buildinfo_includepath())

        # same with the others
        self.failUnless(self.hi1dir_lib_includeinfo_ in self.exedir_main_c_builder_.buildinfo_includepath())
        self.failUnless(self.hi2dir_lib_includeinfo_ in self.exedir_main_c_builder_.buildinfo_includepath())
    ...
    def testIncludeOrder(self):
        ...
        self.failUnlessEqual(len(self.highestdir_highest_c_builder_.buildinfo_includepath()), 3)

        # lo is the lowest in the dependency list, so it must come at the end
        self.failUnless(self.lodir_lib_includeinfo_ is self.highestdir_highest_c_builder_.buildinfo_includepath()[2])

        # hi1 and hi2 are equal orders, so they must come either first or second
        self.failUnless(self.hi1dir_lib_includeinfo_ in self.highestdir_highest_c_builder_.buildinfo_includepath()[0:2])
        self.failUnless(self.hi2dir_lib_includeinfo_ in self.highestdir_highest_c_builder_.buildinfo_includepath()[0:2])
        pass
